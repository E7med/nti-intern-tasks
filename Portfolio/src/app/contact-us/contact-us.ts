...
export class ContactUs {
  ...
  emailjs
    ...
    .catch((err) => {
      ...
      const gmailLink = `https://mail.google.com/mail/?view=cm&fs=1&to=eslam18880@gmail.com&su=${subject}&body=${body}`;      alert('Message failed to send. Redirecting to Gmail to send a message manually.');
